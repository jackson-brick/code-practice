...
def home_menu():
    ...
    print("+-----------------+-----------------+".center(z))
    print("")
    print(f"{studyBuddyName}: Hey there {userName}!".center(z))
    time.sleep(1.5)
    print("I am your study buddy and I am here to help you learn!".center(z))
    time.sleep(2.5)
    print("You can choose between statistics (STATS), computer science and programming (CSP),".center(z))
    print("physics (PHYS), and spanish (SPAN)!".center(z))
    input()
