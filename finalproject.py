...
input()
#study_buddy_wake_animation() #YOU MIGHT WANT TO HASHTAG THIS OUT IF YOU ARE TESTING CODE MULTIPLE TIMES, THE ANIMATION IS VERY LONG
print("Please welcome the one, the only, Study Buddy! (Press ENTER to  continue)".center(z))
input()
user_intro() #asks for the user's name and to name their Study Buddy
while True: #this while loop is never broken out of, only way to end inside a run is to type quit, and at the end sys.exit() is used
    home_menu()
